...
# And ISSP
rm(list=ls())
issp_1 <- load("./data/final_data/regression_outputs/per_wave/issp_results_df1_new.RData")
issp_2 <- load("./data/final_data/regression_outputs/per_wave/issp_results_df2_new.RData")
...
total_results_waves$attitude_cat[total_results_waves$dep_var == "dodiff" 
                               ...
                               | total_results_waves$dep_var == "motivr"
