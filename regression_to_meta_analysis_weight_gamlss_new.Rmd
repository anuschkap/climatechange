...
library(here)
here()
here::i_am("scripts/analysis/regression_to_meta_analysis_weight_gamlss_new.Rmd")
```
...
load(here("./data/final_data/regression_outputs", "ess_list_empty_w.RData"))
...
load(here("./data/final_data/regression_outputs", "evs_list_empty_w.RData"))
...
load(here("./data/final_data/regression_outputs", "io_list_empty_w.RData"))
...
load(here("./data/final_data/regression_outputs", "issp_list_empty_2_waves_w.RData"))
...
# Interaction model 
load(here("./data/final_data/regression_outputs", "issp_list_interactions_2_waves_w.RData"))
...
rm(list=ls())
load(here("./data/final_data/regression_outputs", "issp_list_interactions_2_waves_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_1986_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_2007_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_2008_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_2009_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_2011_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_buyprod_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_cchange2_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_doprot_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_eff_daily_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_pers_imp_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_prsaction_w.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_empty_quallife_w.RData"))
...
load(here("./data/final_data/regression_outputs", "eb_results_empty_df_w_new.RData"))
load(here("./data/final_data/regression_outputs", "eb_results_preds_df_w_new.RData"))
...
rm(list=ls())
load(here("./data/final_data/regression_outputs", "ess_results_df_w_new.RData"))
load(here("./data/final_data/regression_outputs", "evs_results_df_w_new.RData"))
load(here("./data/final_data/regression_outputs", "io_results_df_w_new.RData"))
load(here("./data/final_data/regression_outputs", "issp_results_df_w_new.RData"))
load(here("./data/final_data/regression_outputs", "issp_results_2_df_new.RData"))
load(here("./data/final_data/regression_outputs", "eb_results_df_w_new.RData"))
