...
#Mean attitudes 
png(file = "./output/forestplot_neg_to_pos_weight_NEW_OCTOBER.png", width = 2800, height = 2400, res = 300)
...
png(file = "./output/forestplot_variance_NEW_OCTOBER.png", width = 2800, height = 2400, res = 300)
...
model_1_mean_df$Variable <- c("Intercept", "Mean year", "Attitude behavioral (ref = aff)", "Attitude cognitive", "Ambigious (ref = no)")
...
model_2_mean_df$Variable <- c("Intercept", "Mean year", "Attitude behavioral (ref = aff)", "Attitude cognitive", "Ambigious (ref = no)")
...
model_3_mean_df$Variable <- c("Intercept", "Mean year", "Attitude behavioral (ref = aff)", "Attitude cognitive", "Ambigious (ref = no)")
...
model_1_var_df$Variable <- c("Intercept", "Mean year", "Attitude behavioral (ref = aff)", "Attitude cognitive", "Ambigious (ref = no)")
...
model_2_var_df$Variable <- c("Intercept", "Mean year", "Attitude behavioral (ref = aff)", "Attitude cognitive", "Ambigious (ref = no)")
...
model_3_var_df$Variable <- c("Intercept", "Mean year", "Attitude behavioral (ref = aff)", "Attitude cognitive", "Ambigious (ref = no)")
...
kable(total_meta, digits = 3, caption = "Table 3. Meta-regression on climate change attitudes and polarization", 
  ...
  add_header_above(c(" " = 2, "Time-only model" = 3, "Indepent var model" = 3)) %>%
   footnote(
    ...
    save_kable("./output/meta_regression_table_NEW_OCTOBER.html")
```
