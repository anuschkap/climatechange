...
save(eb1986sel, file="./data/all_waves/eb1986sel.Rdata")
```
...
save(eb1992sel, file="./data/all_waves/eb1992sel.Rdata")
```
...
save(eb1995sel, file="./data/all_waves/eb1995sel.Rdata")
```
...
save(eb2004sel, file="./data/all_waves/eb2004sel.Rdata")
...
save(eb2007sel, file="./data/all_waves/eb2007sel.Rdata")
```
...
save(eb2008sel, file="./data/all_waves/eb2008sel.Rdata")
```
...
save(eb2009asel, file="./data/all_waves/eb2009asel.Rdata")
```
...
save(eb2009bsel, file="./data/all_waves/eb2009bsel.Rdata")
```
...
save(eb2011asel, file="./data/all_waves/eb2011asel.Rdata")
```
...
save(eb2011bsel, file="./data/all_waves/eb2011bsel.Rdata")
```
...
save(eb2013sel, file="./data/all_waves/eb2013sel.Rdata")
```
...
save(eb2014sel, file="./data/all_waves/eb2014sel.Rdata")
```
...
save(eb2015sel, file="./data/all_waves/eb2015sel.Rdata")
```
...
save(eb2017asel, file="./data/all_waves/eb2017asel.Rdata")
...
save(eb2017bsel, file="./data/all_waves/eb2017bsel.Rdata")
```
...
save(eb2021sel, file="./data/all_waves/eb2021sel.Rdata")
```
...
load("./data/all_waves/eb1986sel.Rdata")
load("./data/all_waves/eb1992sel.Rdata")
load("./data/all_waves/eb1995sel.Rdata")
...
save(ebu2000, file="./data/all_waves/ebu2000.Rdata")

#Now the years under 2010
rm(list = ls())
load("./data/all_waves/eb2004sel.Rdata")
load("./data/all_waves/eb2007sel.Rdata")
load("./data/all_waves/eb2008sel.Rdata")
load("./data/all_waves/eb2009asel.Rdata")
load("./data/all_waves/eb2009bsel.Rdata")
...
save(eb0010, file="./data/all_waves/ebu0010.Rdata")

rm(list=ls())

load("./data/all_waves/eb2011asel.Rdata")
load("./data/all_waves/eb2011bsel.Rdata")
load("./data/all_waves/eb2013sel.Rdata")
load("./data/all_waves/eb2014sel.Rdata")
load("./data/all_waves/eb2015sel.Rdata")
...
save(ebtm15, file="./data/all_waves/ebutm15.Rdata")

#Now the last waves
load("./data/all_waves/eb2017asel.Rdata")
load("./data/all_waves/eb2017bsel.Rdata")
load("./data/all_waves/eb2021sel.Rdata")
...
save(eb17up, file="./data/all_waves/eb17up.Rdata")

# Final merge 
load("./data/all_waves/ebu2000.Rdata")
load("./data/all_waves/ebu0010.Rdata")
load("./data/all_waves/ebutm15.Rdata")
load("./data/all_waves/eb17up.Rdata")
