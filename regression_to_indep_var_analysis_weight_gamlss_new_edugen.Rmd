...
```{r}
load(here("./data/final_data/regression_outputs", "ess_list_preds_w_new_edugen.RData"))
...
save(ess_indep_preds_df, file="/Users/anuschka/Documents/climatechange/climatechange/data/final_data/indep_var/ess_indep_var_df_w_new_edugen.RData")
...
rm(list=ls())
load(here("./data/final_data/regression_outputs", "evs_list_preds_w_new_edugen.RData"))
...
save(evs_indep_preds_df, file="/Users/anuschka/Documents/climatechange/climatechange/data/final_data/indep_var/evs_indep_var_df_w_new_edugen.RData")
```
...
rm(list=ls())
load(here("./data/final_data/regression_outputs", "io_list_preds_w_new_edugen.RData"))
...
save(io_indep_preds_df, file="/Users/anuschka/Documents/climatechange/climatechange/data/final_data/indep_var/io_indep_var_df_w_new_edugen.RData")
```
...
rm(list=ls())
load(here("./data/final_data/regression_outputs", "issp_list_preds_w_new_edugen.RData"))
...
save(issp_indep_preds_df, file="/Users/anuschka/Documents/climatechange/climatechange/data/final_data/indep_var/issp_indep_var_df_w_new_edugen.RData")

# For the other indep vars as well
load(here("./data/final_data/regression_outputs", "issp_list_preds_2_waves_w_new_edugen.RData"))
...
save(issp_2_indep_preds_df, file="/Users/anuschka/Documents/climatechange/climatechange/data/final_data/indep_var/issp_2_indep_var_df_w_new_edugen.RData")
```
...
rm(list=ls())
load(here("./data/final_data/regression_outputs", "eb_list_preds_1986_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_2007_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_2008_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_2009_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_2011_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_buyprod_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_cchange2_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_doprot_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_eff_daily_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_pers_imp_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_prsaction_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_quallife_w_new_edugen.RData"))
load(here("./data/final_data/regression_outputs", "eb_list_preds_doprot_city_w_new_edugen.RData"))
```
...
save(eb_indep_preds_df, file= "/Users/anuschka/Documents/climatechange/climatechange/data/final_data/indep_var/eb_indep_var_df_w_new_edugen.RData" )
```
...
rm(list=ls())
load(here("./data/final_data/indep_var", "eb_indep_var_df_w_new_edugen.RData"))
load(here("./data/final_data/indep_var", "ess_indep_var_df_w_new_edugen.RData"))
load(here("./data/final_data/indep_var", "evs_indep_var_df_w_new_edugen.RData"))
load(here("./data/final_data/indep_var", "io_indep_var_df_w_new_edugen.RData"))
load(here("./data/final_data/indep_var", "issp_2_indep_var_df_w_new_edugen.RData"))
load(here("./data/final_data/indep_var", "issp_indep_var_df_w_new_edugen.RData"))
...
save(total_indep_var_results, file= "/Users/anuschka/Documents/climatechange/climatechange/data/meta_analysis/total_indep_var_results_new_edugen.RData" )
```
