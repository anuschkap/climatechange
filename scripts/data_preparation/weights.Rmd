...
```{r}
# Create a table that compares the weighted and unweighted proportions, using the ISSP 2000 as an example. 
...
weight_table <- kable(table_total, format = "html", align = "l",
      caption = "Table 1. Proportions weighted and unweighted for ISSP 2000") %>%
