...
table(issp1993$V277, useNA = "always")
table(issp1993$V352, useNA = "always")
...
table(issp93sel$V277, useNA = "always") #18 missings on church attendance
...
table(as.numeric(as.character(issp00sel$V241)), useNA = "always")
