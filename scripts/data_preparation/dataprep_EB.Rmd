...
eb2021sel <- eb2021sel %>% select(studyno1, w1, cchange, cchange2, cchangetot, ccpercept, eduyrs, sex, age, urban, lrplace ) %>% rename(v1 = studyno1, v8 = w1)
