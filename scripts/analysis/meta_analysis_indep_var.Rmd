...
indep_total <- select(indep_total, mu_sigma_1, variable_1, pooled_1, p_text_1, estimate, se, p_text_2, pooled_2, p_text_3)
...
kable(indep_total, digits = 3, caption = "Table 4. Effects of independent variables on climate change attitudes and polarization", 
  ...
  add_header_above(c(" " = 2, "Effects indep vars" = 2, "Mean year on indep vars" = 3, "Indep vars x time" = 2), align = "c") %>%
   footnote(
    general_title = "Note.",
