...
png <- forest(model_step_1_var, colout = colour.palette, col = "#ACBFD6", annotate = TRUE, header = "Forest plot time effect attitudes", slab = total_reg_results$dep_var, pch = 23,fonts = "Helvetica", cex = 0.5, mlab = "Pooled estimate", ilab = attitude_cat, ilab.xpos = -2, xlim = c(-1, 1), order = "yi")
...
forest_data <- total_reg_results %>% dplyr::select(dep_var, mu_time)
