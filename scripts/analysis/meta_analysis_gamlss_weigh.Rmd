...
```{r}
# Run the meta-regressions on subsets of the data per attitude cat, and make a table out of that 
...
one_df$Variable <- "Affective Mean"
...
three_df$Variable <- "Behavioral Mean"
...
five_df$Variable <- "Cognitive Mean"
...
abc_model <- select(abc_model, Variable, Estimate, SE, p_text)

kable(abc_model, format = "html", align = "l",
  ...
  save_kable("/Users/anuschka/Documents/climatechange/climatechange/output/appendix/abc_table.png")
