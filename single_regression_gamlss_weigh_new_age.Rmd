...
save(ess_list_preds, file="./data/final_data/regression_outputs/ess_list_preds_w_new_age.RData")
```
...
save(evs_list_preds, file="./data/final_data/regression_outputs/evs_list_preds_w_new_age.RData")
```
...
save(io_list_preds, file="./data/final_data/regression_outputs/io_list_preds_w_new_age.RData")
```
...
save(issp_list_preds, file="./data/final_data/regression_outputs/issp_list_preds_w_new_age.RData")
...
save(issp_list_preds_2_waves, file="./data/final_data/regression_outputs/issp_list_preds_2_waves_w_new_age.RData")
```
...
save(eb_list_preds_1986, file="./data/final_data/regression_outputs/eb_list_preds_1986_w_new_age.RData")
```
...
save(eb_list_preds_quallife, file="./data/final_data/regression_outputs/eb_list_preds_quallife_w_new_age.RData")
```
...
save(eb_list_preds_2007, file="./data/final_data/regression_outputs/eb_list_preds_2007_w_new_age.RData")
```
...
save(eb_list_preds_buyprod, file="./data/final_data/regression_outputs/eb_list_preds_buyprod_w_new_age.RData")
```
...
save(eb_list_preds_eff_daily, file="./data/final_data/regression_outputs/eb_list_preds_eff_daily_w_new_age.RData")
```
...
save(eb_list_preds_2008, file="./data/final_data/regression_outputs/eb_list_preds_2008_w_new_age.RData")
```
...
save(eb_list_preds_2009, file="./data/final_data/regression_outputs/eb_list_preds_2009_w_new_age.RData")
```
...
save(eb_list_preds_pers_imp, file="./data/final_data/regression_outputs/eb_list_preds_pers_imp_w_new_age.RData")
```
...
save(eb_list_preds_doprot, file="./data/final_data/regression_outputs/eb_list_preds_doprot_w_new_age.RData")
```
...
save(eb_list_preds_2011, file="./data/final_data/regression_outputs/eb_list_preds_2011_w_new_age.RData")
```
...
save(eb_list_preds_cchange2, file="./data/final_data/regression_outputs/eb_list_preds_cchange2_w_new_age.RData")
```
...
save(eb_list_preds_prsaction, file="./data/final_data/regression_outputs/eb_list_preds_prsaction_w_new_age.RData")
```
...
save(eb_list_preds_doprot_city, file="./data/final_data/regression_outputs/eb_list_preds_doprot_city_w_new_age.RData")
```
