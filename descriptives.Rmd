...
hist(total_inter_results$sig_sex_est_inter_std)
hist(total_inter_results$sig_age_est_inter_std)
...
m2_var <- rma(yi = sig_time_pred_std,
              sei = sig_time_sd_pred_std,
              data = total_reg_results,
              method = "ML",
              test = "knha")

# Gender
gender_var_gen <- metagen(TE = sig_sex_est_std,
                 seTE = sig_sex_sd_std,
                 data = total_indep_var_results,
                 fixed = FALSE,
                 random = TRUE,
...
# Age
age_var_gen <- metagen(TE = sig_age_est_std,
                 seTE = sig_age_sd_std,
                 data = total_indep_var_results,
                 fixed = FALSE,
                 random = TRUE,
...
# Education
edu_var_med_gen <- metagen(TE = sig_isced_med_est_std,
                 seTE = sig_isced_med_sd_std,
                 data = total_indep_var_results,
                 fixed = FALSE,
                 random = TRUE,
                 method.tau = "ML",
...
edu_var_high_gen <- metagen(TE = sig_isced_high_est_std,
                 seTE = sig_isced_high_sd_std,
                 data = total_indep_var_results,
                 fixed = FALSE,
                 random = TRUE,
                 method.tau = "ML",
...
# Gender 
gender_gen_int_var <- metagen(TE = sig_sex_est_std,
                 seTE = sig_sex_sd_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
...
# Age 
age_gen_int_var <- metagen(TE = sig_age_est_std,
                 seTE = sig_age_sd_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
...
# Educational level
edu_med_gen_int_var <- metagen(TE = sig_isced_med_est_std,
                 seTE = sig_isced_med_sd_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
...
edu_high_gen_int_var <- metagen(TE = sig_isced_high_est_std,
                 seTE = sig_isced_high_sd_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
...
# And the interaction effects 
# Gender 
gender_int_eff_var <- metagen(TE = sig_sex_est_inter_std,
                 seTE = sig_sex_sd_inter_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
                 method.tau = "ML",
...
# Age 
age_int_eff_var <- metagen(TE = sig_age_est_inter_std,
                 seTE = sig_age_sd_inter_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
                 method.tau = "ML",
...
# Educational level
edu_med_int_eff_var <- metagen(TE = sig_isced_med_est_inter_std,
                 seTE = sig_isced_med_sd_inter_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
                 method.tau = "ML",
...
edu_high_int_eff_var <- metagen(TE = sig_isced_high_est_inter_std,
                 seTE = sig_isced_high_sd_inter_std,
                 data = total_inter_results,
                 fixed = FALSE,
                 random = TRUE,
                 method.tau = "ML",
